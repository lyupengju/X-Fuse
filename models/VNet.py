...
class VNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=60, normalization='none', has_dropout=False, has_residual=False):
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        model = VNet(n_channels=1, n_classes=2,  n_filters=30,normalization='batchnorm', has_dropout=False).cuda()
    ...
    #     images = torch.randn(1,1,96,96,96)
    #     model = VNet(n_channels=1, n_classes=2,  n_filters=30,normalization='batchnorm', has_dropout=False)
    #     # model = MCNet3d_v1(n_channels=1, n_classes=2,  n_filters=30, normalization='batchnorm', has_dropout=False)
    ...
    #         test_data = sliding_window_inference(
    #             images,(96,96,96), 1, model, overlap=0.5,sw_device='cuda',device='cpu')
